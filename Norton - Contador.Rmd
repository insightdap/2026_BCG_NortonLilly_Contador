...
output: 
  flexdashboard::flex_dashboard:
    ...
    theme:
      ...
      navbar-bg: "#CCCCCC"  #Color barra de navegación
...
#Importación   --------------------------------------------------------
data <- read_sheet("1y9b4mrq1U2wfL8SOsLNrNHtwpGKHk7iChTcuqNGFELk") %>% 
  select(1:4,genero,generacion,tiempo_laboral,nivel_jerarquico) %>% 
  mutate(`Submitted at` = as.POSIXct(`Submitted at`),
         fecha = `Submitted at`- hours(6))

principal <- read_sheet("1NUhVQCGM9ARcS2qjQCOUzqldgaqPnzhFD_pVnQt7Ug0")
